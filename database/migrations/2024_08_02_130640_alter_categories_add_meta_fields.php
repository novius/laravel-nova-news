...
return new class extends Migration
{
    ...
    {
        Schema::table('nova_news_categories', static function (Blueprint $table) {
            $table->addMeta();
        });

        DB::table('nova_news_categories')->orderBy('id')->chunk(100, function ($posts) {
            foreach ($posts as $post) {
                ...
                DB::table('nova_news_categories')->where('id', $post->id)->update([
