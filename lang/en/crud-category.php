...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Categories Crud Language Lines
    |--------------------------------------------------------------------------
    |
    | The following language lines are used in your Categories CRUD throughout the
    ...
    */
    ...
    'resource_label_singular' => 'Category',

    'panel_post_informations' => 'Category informations',
